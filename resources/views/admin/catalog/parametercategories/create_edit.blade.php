...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/catalog/parametercategories') }}"><i class="fa fa-folder-open-o"></i> Категории
                    параметров</a></li>
            <li class="active"><i
                        class="fa {{ isset($parametercategory) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($parametercategory) ? 'Редактировать' : 'Добавить' }}
                категорию
            </li>
        </ol>
    </section>
