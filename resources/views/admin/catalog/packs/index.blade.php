                ...
                <tr>
                    ...
                    @foreach($modifications as $modification)
                        ...
                        <th>
                            ...
                            <input type="checkbox" class="best_price" @if( bestPrice($modification->id, $complectation->id)) checked="checked" @endif data-modification="{!! $modification->id !!}" data-complectation="{!! $complectation->id !!}"  name="best_price"> Лучшая цена
                        </th>
