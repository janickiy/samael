...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/catalog/models/model/' . (isset($catalogmodification) ? $catalogmodification->model : $id_model) . '/modifications' ) }}"><i
                            class="fa fa-list-alt"></i> Модификации</a></li>
            <li class="active"><i
                        class="fa {{ isset($catalogmodification) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($catalogmodification) ? 'Редактировать' : 'Добавить' }}
                модификацию
            </li>
        </ol>
    </section>
