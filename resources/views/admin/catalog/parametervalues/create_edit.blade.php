...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/catalog/parametercategories') }}"><i class="fa fa-list-alt"></i> Категории
                    параметров</a></li>
            <li class="active"><i
                        class="fa {{ isset($parametervalue) ? 'fa-pencil' : 'fa-plus' }}"></i> {{ isset($parametervalue) ? 'Редактировать' : 'Добавить' }}
                параметр
            </li>
        </ol>
    </section>
