...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ url('admin/catalogmodels/model/' . (isset($catalogmodification) ? $catalogmodification->id_car_model : $id_car_model) . '/modifications' ) }}"><i class="fa fa-list-alt"></i> Модификации</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['url' => isset($catalogmodification) ? URL::to('admin/carmodifications/' . $catalogmodification->id )  :  URL::to('admin/carmodifications/') , 'method' => isset($catalogmodification) ? 'put': 'post', 'class' => 'form-horizontal', 'id'=>'validate']) !!}
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {!! Form::text('body_type', old('body_type', isset($catalogmodification) ? $catalogmodification->body_type : null), ['class' => 'form-control validate[required]', 'placeholder'=>'Тип кузов']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {!!  Form::selectYear('year_begin', 1980, date("Y"), isset($catalogmodification) ? $catalogmodification->year_begin : date("Y"), ['class' => 'form-control select2 validate[required]']) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        {!!  Form::selectYear('year_end', 1980, date("Y"), isset($catalogmodification) ? $catalogmodification->year_end : date("Y"), ['class' => 'form-control select2 validate[required]']) !!}
                    </div>
                </div>
