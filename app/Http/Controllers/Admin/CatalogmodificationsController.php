...
class CatalogmodificationsController extends Controller
{
    ...
    {
        return view('admin.catalogmodifications.create_edit')->with('model', $id);;
    }
    ...
    public function update(CatalogModificationsRequest $request, CatalogModification $catalogModification)
    {
       // $modification = CarModification::where('id', $carModification->id)->first();
        ...
        $catalogModification->model = $request->input('model');
        ...
        return redirect('admin/catalogmodels/model/' . $catalogModification->model . '/modifications')->with('success', 'Данные обнавлены');
    }
    ...
    public function store(CatalogModificationsRequest $request)
    {
        ...
        return redirect('admin/catalogmodels/model/' . $request->model . '/modifications')->with('success', ' добавлена');
    }
